...
<marquee direction="scroll"> <h1 style="color: white;">Welcome To our Aditya College Election Portal </h1><br></marquee>
	<div class="container-fluid">


		<div id="my1" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="images/votehere.png" alt="image1" class="img-responsive" style="border-radius: 90px 20px 80px 30px">
				</div>
				<div class="item">	
					<img src="images/election2.png" alt="image2" class="img-responsive" style="border-radius: 90px 20px 80px 30px">
				</div>
				<div class="item">	
					<img src="images/election3.png" alt="image3" class="img-responsive" style="border-radius: 90px 20px 80px 30px">
				</div>
			</div>

			<a  class="left carousel-control" data-slide="prev" href="#my1">
				<span class="glyphicon glyphicon-chevron-left"></span>
				<span class="sr-only">previous</span>
			</a>
			<a  class="right carousel-control" data-slide="next" href="#my1">
				<span class="glyphicon glyphicon-chevron-right"></span>
				<span class="sr-only">next</span>
			</a>
			</div>
        <!-- <div class="col-lg-7 col-md-7 col-sm-7 col-xs-8 second" >
        	<a href="VoterLogin.php" style="text-decoration: none;">
        		<button class="btn btn-info" style="padding-top: 1vw; padding-bottom: 1vw; padding-left:1.2vw; padding-right:1.2vw; float: right;">CONTINUE</button>
        	</a>
        </div> -->
		<!-- <div class="col-lg- col-md-5 col-sm-5 col-xs-5 second" > -->

<!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 second" style="text-align: center;">
        	<a href="VoterLogin.php" style="text-decoration: none;">
        		<button class="btn btn-info" style="padding-top: 1vw; padding-bottom: 1vw; padding-left:1.2vw; padding-right:1.2vw; ">CONTINUE</button>
        	</a>
        </div>
