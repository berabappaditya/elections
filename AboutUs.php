...
<body style="background-image:url('images/total1.jpg');background-opacity: 1;border-radius: 30px;margin: none;">
  ...
  <nav class="navbar navbar-default" >
    ...
    <div class="collapse navbar-collapse" id="mynav">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="VoterLogin.php"><span class="glyphicon glyphicon-user"><b>Candidate</b></span></a></li>
  ...
  <div style="text-align: center;color: white;"><h2><b></b>Meet Our Team</h2></div>
  <!-- aboutus matter about us -->
  <div class="container">
    <div class="row">
      <div class="col-lg-3 col-md-3 col-sm-9 col-xs-9 photos" style="border:1px solid black;margin: 3% 4%;padding: 5%;border-radius: 0px 50px 0px 0px ">
        <div class="chandu">
          <img src="images/chandu.jpg" style="border-radius:50%;overflow: hidden;height: 10%;width: 50%;align-content: center;margin-left: 20%">
          <div>
            <h2 style="text-align: center;color:black"><b>D.CHANDRA SHEKHAR</b></h2>
            <h5 style="text-align: center;color:black"><i><b>STUDENT</b></i></h5>
            <section>
             <span class="footer-social-overlap footer-social-icons-wrapper">
              <a href="https://www.linkedin.com/in/chandra-shekhar-dusari-573224171/s" class="generic-anchor" target="_blank" title="LinkedIn" itemprop="significantLink"><i class="fa fa-linkedin"></i></a>
              <a href="https://www.facebook.com/chandrashekhard.cd/" class="generic-anchor" target="_blank" title="Facebook" itemprop="significantLink"><i class="fa fa-facebook"></i></a>
              <a href="https://twitter.com/@chandud7" class="generic-anchor" target="_blank" title="Twitter" itemprop="significantLink"><i class="fa fa-twitter"></i></a>
              <a href="https://www.instagram.com/its_me_tarak_chandu/" class="generic-anchor" target="_blank" title="Instagram" itemprop="significantLink"><i class="fa fa-instagram"></i></a>
            </span>
          </section>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-3 col-sm-9 col-xs-9 photos" style="border:3px solid voilet;margin: 3% 4%;padding: 5%;border-radius: 0px 50px 0px 0px "">
        <div class="sai">
           <img src="images/sai.jpg" style="border-radius:50%;overflow: hidden;height: 10%;width: 50%;align-content: center;margin-left: 20%">
           <div>
            <h2 style="text-align: center;color:black"><b>D.V.SAI KUMAR</b></h2>
            <h5 style="text-align: center;color:black"><i><b>STUDENT</b></i></h5>
            <section>
             <span class="footer-social-overlap footer-social-icons-wrapper">
      ...
      <div class="col-lg-3 col-md-3 col-sm-9 col-xs-9 photos" style="border:1px solid black;margin: 3%;padding: 5%;border-radius: 0px 50px 0px 0px "">
        <div class="santhosh">
           <img src="images/santhosh.jpg" style="border-radius:50%;overflow: hidden;height: 10%;width: 50%;align-content: center;margin-left: 20%">
           <div>
            <h2 style="text-align: center;color:black"><b>P.SIVA SANTHOSH</b></h2>
            <h5 style="text-align: center;color:black"><i><b>STUDENT</b></i></h5>
            <section>
             <span class="footer-social-overlap footer-social-icons-wrapper">
              <a href="https://www.linkedin.com/company/technicalhub/?originalSubdomain=in" class="generic-anchor" target="_blank" title="LinkedIn" itemprop="significantLink"><i class="fa fa-linkedin"></i></a>
